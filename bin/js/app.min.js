...
(function() {
  var animateElement, calculateAspectRatio, calculateReducedRatio, changeIcon, changeView, empty, isInteger, isNumber, keyupEvent, setAspectRatio;
  ...
  changeView = function(button, oldView, newView) {
    ...
    if (resetView) {
      $(newView).fadeOut(function() {
        return $(resetView).fadeIn(function() {
          return $(button).attr('data-view', '');
        });
      });
    } else {
      $(oldView).fadeOut(function() {
        return $(newView).fadeIn(function() {
          return $(button).attr('data-view', oldView);
        });
      });
    }
    return analytics.track('Changed view', {
      view: newView
    });
  };
  ...
  setAspectRatio = function(getRatio) {
    ...
    return analytics.track('Set Aspect Ratio', {
      ratio: ratio,
      width: width,
      height: height
    });
  ...
  $(function() {
    ...
    return $('#values-wrapper input').keyup(keyupEvent);
  });
